...
package com.stratagile.pnrouter.telegram;
...
public class BottomSheet extends Dialog {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, int type) {
            ...
            imageView.setColorFilter(new PorterDuffColorFilter(getResources().getColor(R.color.white), PorterDuff.Mode.MULTIPLY));
            addView(imageView, createFrame(56, 48, Gravity.CENTER_VERTICAL | (false ? Gravity.RIGHT : Gravity.LEFT)));
            ...
            if (type == 0) {
                ...
                addView(textView, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, (false ? Gravity.RIGHT : Gravity.LEFT) | Gravity.CENTER_VERTICAL));
            } else if (type == 1) {
        ...
        public void setTextAndIcon(CharSequence text, int icon, boolean bigTitle) {
            ...
            if (icon != 0) {
                ...
                if (bigTitle) {
                    textView.setPadding(AndroidUtilities.dp(false ? 21 : 72), 0, AndroidUtilities.dp(false ? 72 : 21), 0);
                    imageView.setPadding(false ? 0 : AndroidUtilities.dp(5), 0, false ? AndroidUtilities.dp(5) : 5, 0);
                } else {
                    textView.setPadding(AndroidUtilities.dp(false ? 16 : 72), 0, AndroidUtilities.dp(false ? 72 : 16), 0);
...
//                    FileLog.e(e);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (title != null) {
            ...
            if (bigTitle) {
                titleView.setTextColor(getContext().getResources().getColor(R.color.mainColor));
