        ...
        public void handleMessage(android.os.Message message) {
            switch (message.what) {
                ...
                case HANDLER_MESSAGE_SEEK_TO:
                    ...
                    KLog.i("消息个数为：" + position);
                    listView.setSelection(position);
//                    listView.postDelayed(new Runnable() {
//                        @Override
//                        public void run() {
//                            if (messages != null && messages.length <= 10) {
//                                KLog.i("小于10个。。" + messages.length);
//                                listView.setSelection(messages.length - 1);
//                            } else {
//                                KLog.i("大于10个。。" + messages.length);
//                                listView.setSelection(position);
//                            }
//                        }
//                    }, 500);
    ...
    protected EaseChatRowPresenter createChatRowPresenter(EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                ...
                if (message.getMsgId().contains(Message.SpecialId.GroupSpecialIdABDFEGEKLOIHHYGJHKIUFEGHEL.toString())) {
                    KLog.i("判断是提示消息！！！");
